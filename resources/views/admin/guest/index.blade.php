    ...
    <div class="card">
      <div class="card-body">
        <div style="padding-bottom: 1%">
            <button type="button" class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#adminPrintPelayananReport"><i data-feather="printer"></i> Cetak Pdf</button>
        </div>
          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#adminPelayananReportDetail{{$lGa->id_guest}}">Info</button>
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#adminDeletePelayananReport{{$lGa->id_guest}}">Hapus</button>
  ...
  <script>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#cancelButtonPelayanan').on('click', function () {
                $('#start_date').val('');
                $('#end_date').val('');
            });
