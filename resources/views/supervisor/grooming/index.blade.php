          ...
          <table id="dataTableExample" class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#tanggapanLaporanGroomingSpv{{$laporan->id_lg}}">Tanggapan</button>
                    ...
                    {{-- @endforeach --}}
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#hapusLaporanGroomingSpv{{$laporan->id_lg}}">Hapus</button>
