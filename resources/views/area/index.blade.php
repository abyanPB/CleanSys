            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal{{$area->id_area}}">Hapus</button>

                    <!-- Modal -->
                    <div class="modal fade" id="exampleModal{{$area->id_area}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
